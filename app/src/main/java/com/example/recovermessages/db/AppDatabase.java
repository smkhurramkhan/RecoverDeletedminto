package com.example.recovermessages.db;
...
public class AppDatabase {
    ...
    public boolean deleteSingleRow(String name) {
        SQLiteDatabase db = new DataDb(this.context).getWritableDatabase();
       return db.delete("users", "username=?", new String[]{name}) > 0;
    }

    public boolean deleteMessageRow(String name) {
        SQLiteDatabase db = new DataDb(this.context).getWritableDatabase();
        return db.delete("messeges", "username=?", new String[]{name}) > 0;
    }
    ...
    public void addUser(String str, String str2, String str3) {
        AppDatabase view_deleted_messages_dbs_appDatabase = this;
        String str4 = str;
        String str5 = str2;
        String str6 = str3;
        String str7 = "package";
        ...
        try {
            SQLiteDatabase writableDatabase = new DataDb(view_deleted_messages_dbs_appDatabase.context).getWritableDatabase();
            ContentValues contentValues = new ContentValues();
    ...
    public boolean isPresent(String str, String str2, String str3) {
        ...
        boolean z = false;
        try {
            SQLiteDatabase readableDatabase = new DataDb(view_deleted_messages_dbs_appDatabase.context).getReadableDatabase();
            SQLiteDatabase sQLiteDatabase = readableDatabase;
    ...
    public ArrayList<String> getAllPackages() {
        String[] array = {"com.whatsapp", "com.whatsapp.w4b", "com.gbwhatsapp", "com.facebook.lite", "com.facebook.orca", "com.facebook.mlite", "com.instagram.android", "com.instagram.lite", "org.telegram.messenger"};
